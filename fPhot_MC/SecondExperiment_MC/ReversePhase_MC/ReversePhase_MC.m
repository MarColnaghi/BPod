...
% To be presented on DAY 9, 10, 11 and 12.
...
for currentTrial = 1: S.GUI.MaxTrials
    ...
    switch trialTypes(currentTrial)
        ...
        % Carvone
        case 1 
            StimulusArgument= {'ValveModule1', 7, 'BNC1',1};        % Insert the number of the valve to be opened WITHOUT odor
            FollowingLED = 'FakeReward';
            EndTrialDuration= S.GUI.EndTrialLength + S.GUI.DrinkingGraceDuration;
        
        % CS+ Reward
        case 2
            StimulusArgument= {'ValveModule1', 6, 'BNC1',1};        % Inser the number of the valve to be opened for odors 
            FollowingLED = 'Reward';
            EndTrialDuration= S.GUI.EndTrialLength;
         
        % CS+ no Reward
        case 3
            StimulusArgument= {'ValveModule1', 6, 'BNC1',1};        % Insert the number of the valve to be opened for odors
            FollowingLED = 'FakeReward';
            EndTrialDuration= S.GUI.EndTrialLength + S.GUI.DrinkingGraceDuration;
